...
{
/************************************************************************************************************************************
 * TODO Il faut rajouter les adresses des serveurs qui heberge l'application
 *************************************************************************************************************************************/
  var HOSTED_VIEWER_ORIGINS = ['null', 'http://mozilla.github.io', 'https://mozilla.github.io', 'http://10.253.255.33:5001', 'http://10.253.254.74', 'http://10.253.254.74:8099'];
...
function getDefaultPreferences() {
  if (!defaultPreferences) {
    defaultPreferences = Promise.resolve({
      ...
      "renderInteractiveForms": false,
      /**
       * TODO enablePrintAutoRotate a true permet lors de l'impression le redimensionnement du format pour chaque page du fax
       */
